...
fig = plot_covariance(risk_models.exp_cov(crypto_df, frequency=365), plot_correlation=True)
st.pyplot(fig)
...
fig = plot_covariance(risk_models.exp_cov(crypto_df, frequency=365), plot_correlation=False)
st.pyplot(fig)
